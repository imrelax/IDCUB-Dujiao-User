<template>
  ...
  <!-- Desktop Sidebar -->
  <aside class="hidden lg:block flex-shrink-0" :class="[compact ? 'lg:w-60' : 'lg:w-64', stretch ? 'h-full' : '']">
    <div class="theme-panel backdrop-blur-xl border rounded-2xl" :class="[compact ? 'p-5' : 'p-6', sticky ? 'sticky top-24' : '', stretch ? 'h-full' : '']">
